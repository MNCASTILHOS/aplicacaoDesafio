...
export default function UsuarioEditar() {
  ...
  useEffect(() => {
    async function getCliente(){
      ...
      setTelefone(response.data.telefone_cliente);
      setRua(response.data.rua_cliente);
      setNumero(response.data.numero_cliente);
      setBairro(response.data.bairro_cliente);
      setCidade(response.data.cidade_cliente);
      ...
      <main className={classes.content}>
        ...
        <Container maxWidth="lg" className={classes.container}>
          <Grid container spacing={3}>
            <Grid item sm={12}>
            <Button style={{marginBottom:10,marginRight:5}} variant="contained" href={'/admin/clientes'}><ArrowBackIcon /> Voltar</Button>
